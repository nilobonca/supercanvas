      ...
      >
        ...
        <div className="px-6 py-4 border-b border-stone-200 dark:border-white/10 flex items-center justify-between bg-stone-50/50 dark:bg-black/20">
          <div className="flex items-center gap-2.5">
            <div className="w-7 h-7 rounded-lg bg-purple-50 dark:bg-purple-950/30 border border-purple-200 dark:border-purple-800/40 flex items-center justify-center text-purple-600 dark:text-purple-400">
          ...
          {!selectedTemplate ? (
            templates.length === 0 ? (
              <div className="py-8 px-4 text-center flex flex-col items-center">
                <div className="w-12 h-12 rounded-xl bg-purple-50 dark:bg-purple-950/30 border border-purple-200 dark:border-purple-800/40 flex items-center justify-center text-purple-600 dark:text-purple-400 mb-3">
              ...
              <div className="space-y-2 max-h-[380px] overflow-y-auto custom-scrollbar pr-1">
                {templates.map((tmpl) => (
                  <div
                    ...
                    className="flex items-center justify-between p-3 rounded-xl bg-white dark:bg-white/5 border border-stone-200/90 dark:border-white/10 hover:border-purple-300 dark:hover:border-purple-500/40 hover:bg-stone-50 dark:hover:bg-white/[0.08] cursor-pointer transition-all shadow-xs group"
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      <div className="w-8 h-8 rounded-lg bg-purple-50 dark:bg-purple-950/30 border border-purple-200 dark:border-purple-800/40 flex items-center justify-center text-purple-600 dark:text-purple-400 shrink-0">
                        <FileText className="w-4 h-4" />
                      </div>
                      <div className="min-w-0">
                        <h4 className="text-xs font-semibold text-stone-800 dark:text-neutral-200 group-hover:text-purple-700 dark:group-hover:text-purple-300 transition-colors truncate">
                          {tmpl.name}
                        </h4>
                    ...
                    <div className="flex items-center gap-1 shrink-0">
                      ...
                      <ChevronRight className="w-4 h-4 text-stone-400 group-hover:text-purple-600 dark:group-hover:text-purple-400 group-hover:translate-x-0.5 transition-all" />
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 p-3 rounded-xl bg-purple-50 dark:bg-purple-950/30 border border-purple-200 dark:border-purple-800/40">
                <div className="w-8 h-8 rounded-lg bg-white dark:bg-white/10 border border-purple-200 dark:border-purple-800/40 flex items-center justify-center text-purple-600 dark:text-purple-400 shrink-0">
                  <FileText className="w-4 h-4" />
                </div>
                <div>
                  <h4 className="text-xs font-semibold text-purple-900 dark:text-purple-200">{selectedTemplate.name}</h4>
                  <span className="text-[11px] text-purple-700 dark:text-purple-300">Modelo selecionado</span>
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white dark:bg-black/30 border border-stone-200 dark:border-white/10 rounded-lg px-3.5 py-2 text-xs text-stone-900 dark:text-neutral-100 placeholder-stone-400 dark:placeholder-neutral-500 outline-none focus:border-purple-400 dark:focus:border-purple-500 transition-colors shadow-xs"
                />
              </div>
              ...
              <div className="flex items-center justify-between pt-2">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-lg text-xs font-medium bg-purple-600 hover:bg-purple-500 text-white shadow-xs disabled:opacity-40 transition-colors cursor-pointer"
                >
